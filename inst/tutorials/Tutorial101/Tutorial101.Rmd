...
quiz(
  question("El coeficiente de corelación toma si signio positivo o negativo", 
           ...
           allow_retry = TRUE,
           answer("Del valor esperado de X", message = "No...intentalo de nuevo!"),
           answer("Del valor esperado de Y", message = "No...intentalo de nuevo!"),
           answer("De la varianza de X por la varianza de Y", message = "Incorrecto. Intenta de nuevo!."),
           answer("Del valor esperado conjunto de x y Y", correct = TRUE),
           # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
           submit_button = "Enviar respuesta",
           try_again_button = "Intentar de nuevo"),
  # Si no ponemos un caption aparecerá la palabra Quiz en inglés.
...
quiz(
  question("De la gáfica se puede afirmar", 
...
quiz(
  question("Suponga que la correlación de Pearson entre dos variables es igual a 0.56. Podemos afirmar que:", 
           ...
           allow_retry = TRUE,
           answer("Existe una relación media entre las variables", message = "Cerca, pero no...intentalo de nuevo!"),
...
data("arboles")
i=c(3,4,5)
arboles[ , i] <- apply(arboles[ , i], 2, function(x) as.numeric(as.character(x)))
cor(,)
...
data("arboles")
i=c(3,4,5)
arboles=arboles[ , i] <- apply(arboles[ , i], 2, function(x) as.numeric(as.character(x)))
cor.test(arboles[,3:5])
