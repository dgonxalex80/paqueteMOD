...
quiz(
  question("",
           ...
           allow_retry = TRUE,
           answer("Un parqueadero adicional, incrementa el precio de la vivienda en 130.6 millonrd ", message = "Cerca, pero no...intentalo de nuevo!"),
           answer("Una habitación adicional vale 48.8 millones", correct = TRUE), 
           answer("Cada metro cuadrado adicional de área construida incrementa la vivienda en $ 3090", message = "Incorrecto. Intenta de nuevo!."),
