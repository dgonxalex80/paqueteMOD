...
train.dat <- datosR[index_train,]  # muestra de entrenamiento
test.dat <- datosR[-index_train,]  # muestra de prueba  
prop.table(table(train.dat$rotacion))
```
...
test.dat <- datosR[-index_train,]  # muestra de prueba
# oversampling
train.blc <- ovun.sample(rotacion~edad + viaje.negocios_ + departamento_ + distancia.casa, data = train.dat, 
                         p = 0.5, seed = 1, 
                         method = "over")$data

test.blc <- ovun.sample(rotacion~ edad + viaje.negocios_ + departamento_ + distancia.casa, data = test.dat, 
                         p = 0.5, seed = 1, 
                         method = "over")$data

prop.table(table(test.blc$rotacion)) 
prop.table(table(train.blc$rotacion))
...
**Nota** En caso de que elcódigo no corra dentro del tutorial, copielo en un script de su RStudio local y corralo. Debe funcionar
