...
quiz(
  question("La función que permite linealizar la razón odds en el modelo logit es:",
           ...
           answer("logística", message = "Incorrecto. Intenta de nuevo!."),
           # Si no cambiamos estos textos en los botones, se mostrarán en Inglés
           submit_button = "Enviar respuesta",
           try_again_button = "Intentar de nuevo"),
  # Si no ponemos un caption aparecerá la palabra Quiz en inglés.
...
quiz(
  question(" " ,
           ...
           answer("Para su interpretación es necesario transformar el estimador con la función exponencial (exp{0.14415}= 1.55057), indicando el incremento en la razón odds causado por un incremento unitario en la variable independiente", correct = TRUE),
           # Si no cambiamos estos textos en los botones, se mostrarán en Inglés
           submit_button = "Enviar respuesta",
           try_again_button = "Intentar de nuevo"),
  # Si no ponemos un caption aparecerá la palabra Quiz en inglés.
