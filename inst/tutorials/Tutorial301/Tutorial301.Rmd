...
quiz(
  question("El estimador b1=0.14415  se puede interpretar como: " ,
           correct = "Correcto!.",
           allow_retry = TRUE,
...
train<-datosR[index_train,]  # muestra de entrenamiento
test<-datosR[-index_train,]  # muestra de prueba

table(test$rotacion) %>% 
  prop.table()

table(train$rotacion) %>% 
  prop.table()
```
