...
save(train_dat, file = "train_dat.RData")
save(test_dat, file = "test_dat.RData")
load("train_dat.RData")
load("test_dat.RData")
...
save(train_blc, file = "train_blc.RData")
save(test_blc, file = "test_blc.RData")
# load("train_blc.RData")
# load("test_blc.RData")
...
**Nota** En caso de que el código no corra dentro del tutorial, cópielo en un script de su RStudio local y corralo. Debe funcionar
